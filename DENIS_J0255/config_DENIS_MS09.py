...
file_params = 'config_DENIS_MS09.py'
...
free_params = {
    ...
    #'cloud_fraction': [(0,1), r'$\xi_\mathrm{cl}$'], 
    #'log_K_zz': [(5,13), r'$\log\ K_\mathrm{zz}$'], 
    #'sigma_g': [(1.05,3), r'$\sigma_\mathrm{g}$'], 
    #'log_X_MgSiO3': [(-2.3,1), r'$\log\ X_\mathrm{MgSiO3}$'], 
    #'f_sed': [(0,20), r'$f_\mathrm{sed}$'], 
    ...
    # PT profile
    'log_P_1': [(-6,2), r'$\log\ P_1$'], 
    'log_P_2': [(-6,2), r'$\log\ P_2$'], 
    'log_P_3': [(-2,5), r'$\log\ P_3$'], 

    'alpha_1': [(0,1), r'$\alpha_1$'], 
    'alpha_2': [(0,1), r'$\alpha_2$'], 
