...
file_params = 'config_DENIS_parameterised_chem.py'

####################################################################################
# Files and physical parameters
####################################################################################

prefix = 'DENIS_J0255_parameterised_chem'
...
free_params = {
    ...
    # Chemistry
    'log_12CO_0': [(-10,-2), r'$\log\ \mathrm{^{12}CO}_0$'], 
    'log_12CO_1': [(-10,-2), r'$\log\ \mathrm{^{12}CO}_1$'], 
    'log_12CO_2': [(-10,-2), r'$\log\ \mathrm{^{12}CO}_2$'], 
    'log_P_12CO': [(-6,2), r'$\log\ P(\mathrm{^{12}CO})$'], 

    'log_H2O_0': [(-10,-2), r'$\log\ \mathrm{H_{2}O}_0$'], 
    'log_H2O_1': [(-10,-2), r'$\log\ \mathrm{H_{2}O}_1$'], 
    'log_H2O_2': [(-10,-2), r'$\log\ \mathrm{H_{2}O}_2$'], 
    'log_P_H2O': [(-6,2), r'$\log\ P(\mathrm{H_{2}O})$'], 

    'log_CH4_0': [(-10,-2), r'$\log\ \mathrm{CH_{4}}_0$'], 
    'log_CH4_1': [(-10,-2), r'$\log\ \mathrm{CH_{4}}_1$'], 
    'log_CH4_2': [(-10,-2), r'$\log\ \mathrm{CH_{4}}_2$'], 
    'log_P_CH4': [(-6,2), r'$\log\ P(\mathrm{CH_{4}})$'], 
