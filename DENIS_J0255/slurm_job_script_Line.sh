...
sed -i 's/import config_DENIS as conf/import config_DENIS_nominal_2_Line as conf/g' retrieval.py
...
sed -i 's/import config_DENIS_nominal_2_Line as conf/import config_DENIS as conf/g' retrieval.py
