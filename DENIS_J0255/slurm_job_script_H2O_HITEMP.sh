...
sed -i 's/H2O_pokazatel_main_iso/H2O_main_iso' $HOME/retrieval_base/retrieval_base/chemistry.py
sed -i 's/import config_DENIS as conf/import config_DENIS_H2O_HITEMP as conf/g' retrieval.py
...
sed -i 's/import config_DENIS_H2O_HITEMP as conf/import config_DENIS as conf/g' retrieval.py
sed -i 's/H2O_main_iso/H2O_pokazatel_main_iso' $HOME/retrieval_base/retrieval_base/chemistry.py
