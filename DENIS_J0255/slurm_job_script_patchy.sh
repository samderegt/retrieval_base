...
sed -i 's/import config_DENIS as conf/import config_DENIS_patchy as conf/g' retrieval.py
...
sed -i 's/import config_DENIS_patchy as conf/import config_DENIS as conf/g' retrieval.py
