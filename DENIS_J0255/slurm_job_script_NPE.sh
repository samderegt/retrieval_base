...
sed -i 's/import config_DENIS as conf/import config_DENIS_NPE as conf/g' retrieval.py
...
sed -i 's/import config_DENIS_NPE as conf/import config_DENIS as conf/g' retrieval.py
