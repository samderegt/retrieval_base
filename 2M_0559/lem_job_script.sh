...
sed -i 's/import config as conf/import config_fiducial_K as conf/g' retrieval_script.py
...
sed -i 's/import config_fiducial_K as conf/import config as conf/g' retrieval_script.py
