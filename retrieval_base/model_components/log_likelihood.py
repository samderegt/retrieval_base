...
class LogLikelihood:
    def __init__(self, d_spec, sum_model_settings=True, scale_flux=False, scale_err=False, alpha=2, N_phi=1, scale_relative_to_chip=-1, **kwargs):
        ...
        self._combine_model_settings(d_spec, sum_model_settings)
    ...
    def __call__(self, m_flux, Cov):
        ...
        for i, (d_flux_i, m_flux_i, Cov_i) in enumerate(zip(self.d_flux, m_flux, Cov)):
            ...
            if apply_scaling:
                ...
                _, self.phi[i] = self._get_flux_scaling(d_flux_i[mask], m_flux_i[mask], Cov_i)
    ...
    def _combine_model_settings(self, d_spec, sum_model_settings=True):
        """
