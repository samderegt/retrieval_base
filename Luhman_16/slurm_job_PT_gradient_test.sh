...
#SBATCH --job-name=PT_gradient_test
...
sed -i 's/import config as conf/import config_PT_gradient_test as conf/g' retrieval_script.py
...
sed -i 's/import config_PT_gradient_test as conf/import config as conf/g' retrieval_script.py
