...
#SBATCH --job-name=fiducial_JK_B_ret_1
...
sed -i 's/import config as conf/import config_fiducial_JK_B as conf/g' retrieval_script.py
...
sed -i 's/import config_fiducial_JK_B as conf/import config as conf/g' retrieval_script.py
