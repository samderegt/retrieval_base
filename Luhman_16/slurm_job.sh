...
sed -i 's/import config as conf/import config_order_2300_nm as conf/g' retrieval_script.py
...
sed -i 's/import config_order_2300_nm as conf/import config as conf/g' retrieval_script.py
