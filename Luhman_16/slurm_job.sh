...
#SBATCH --job-name=fiducial_JK_A_ret_1
...
sed -i 's/import config as conf/import config_fiducial_JK_A as conf/g' retrieval_script.py
...
sed -i 's/import config_fiducial_JK_A as conf/import config as conf/g' retrieval_script.py
