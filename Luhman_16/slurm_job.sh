...
sed -i 's/import config as conf/import config_order_6 as conf/g' retrieval_script.py
...
sed -i 's/import config_order_6 as conf/import config as conf/g' retrieval_script.py
