...
file_params = 'config_order_2300_nm.py'

####################################################################################
# Files and physical parameters
####################################################################################

prefix = 'order_2300_nm_GPs'
...
free_params = {
    ...
    'log_K': [(-10,-2), r'$\log\ \mathrm{K\ I}$'], 
    'log_Na': [(-10,-2), r'$\log\ \mathrm{Na\ I}$'], 
    'log_Ti': [(-10,-2), r'$\log\ \mathrm{Ti\ I}$'], 
