...
config_data = dict(
    nirspec_g140h_12_A = dict(instrument='JWST', kwargs={'file':'./data/nirspec_140h_12.dat', 'grating':'G235H', 'min_SNR':3}),  # 2 columns
    nirspec_g140h_12_B = dict(instrument='JWST', kwargs={'file':'./data/nirspec_140h_12.dat', 'grating':'G235H', 'min_SNR':3}),  
)
...
cloud_kwargs = dict(
    ...
    nirspec_g140h_12_A = dict(
        cloud_species = ['Fe(s)_amorphous__Mie', 'Mg2SiO4(s)_amorphous__Mie'], 
    ), 
    nirspec_g140h_12_B = dict(
...
pRT_Radtrans_kwargs = dict(
    nirspec_g140h_12_A = dict(line_species=line_species, cloud_species=cloud_kwargs['nirspec_g140h_12_A']['cloud_species']), 
    nirspec_g140h_12_B = dict(line_species=line_species, cloud_species=cloud_kwargs['nirspec_g140h_12_B']['cloud_species']), 
