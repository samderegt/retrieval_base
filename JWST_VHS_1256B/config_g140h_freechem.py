...
free_params = {
    ...
    'log_CrH':     ['U', (-14,-2), r'$\log\ \mathrm{CrH}$'],
    #'log_VO':      ['U', (-14,-2), r'$\log\ \mathrm{VO}$'],
    #'log_TiO':     ['U', (-14,-2), r'$\log\ \mathrm{TiO}$'],
...
pRT_Radtrans_kwargs = dict(
    ...
    nirspec_g140h_1 = dict(line_species=chem_kwargs['nirspec_g140h_1']['line_species']),
    nirspec_g140h_2 = dict(line_species=chem_kwargs['nirspec_g140h_2']['line_species']),
