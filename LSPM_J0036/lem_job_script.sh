...
sed -i 's/import config as conf/import config_J as conf/g' retrieval_script.py
...
sed -i 's/import config_J as conf/import config as conf/g' retrieval_script.py
